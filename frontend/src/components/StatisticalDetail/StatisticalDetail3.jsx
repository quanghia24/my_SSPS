...
const StatisticalDetail3 = () => {
  const data = [
    { id: 1, printer: "Máy in 1", orderNumber: 11, pagesA3: 2, pagesA4: 14 },
    { id: 2, printer: "Máy in 2", orderNumber: 12, pagesA3: 1, pagesA4: 22},
    { id: 3, printer: "Máy in 3", orderNumber: 17, pagesA3: 1, pagesA4: 10 },
    { id: 4, printer: "Máy in 4", orderNumber: 15, pagesA3: 5, pagesA4: 11 },
  ...
  return (
    <div>
      <div className="mainContain">
        <div className="title">
          <h2>Báo cáo hệ thống tháng 3 năm 2023</h2>
        </div>
...
export default StatisticalDetail3