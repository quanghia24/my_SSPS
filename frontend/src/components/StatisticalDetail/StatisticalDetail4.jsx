...
const StatisticalDetail4 = () => {
  const data = [
    { id: 1, printer: "Máy in 1", orderNumber: 10, pagesA3: 3, pagesA4: 15 },
    { id: 2, printer: "Máy in 2", orderNumber: 10, pagesA3: 4, pagesA4: 15},
    { id: 3, printer: "Máy in 3", orderNumber: 8, pagesA3: 5, pagesA4: 11 },
    { id: 4, printer: "Máy in 4", orderNumber: 9, pagesA3: 5, pagesA4: 8 },
    { id: 5, printer: "Máy in 5", orderNumber: 11, pagesA3: 4, pagesA4: 12 },
  ];
  const barData = {
  ...
  return (
    <div>
      <div className="mainContain">
        <div className="title">
          <h2>Báo cáo hệ thống tháng 4 năm 2023</h2>
        </div>
...
export default StatisticalDetail4