...
const StatisticalDetail = () => {
  const data = [
    { id: 1, printer: "Máy in 1", orderNumber: 10, pagesA3: 5, pagesA4: 10 },
    { id: 2, printer: "Máy in 2", orderNumber: 4, pagesA3: 3, pagesA4: 7 },
    { id: 3, printer: "Máy in 3", orderNumber: 2, pagesA3: 2, pagesA4: 4 },
    { id: 4, printer: "Máy in 4", orderNumber: 3, pagesA3: 6, pagesA4: 8 },
    { id: 5, printer: "Máy in 5", orderNumber: 3, pagesA3: 4, pagesA4: 9 },
  ];
  const barData = {
  ...
  return (
    <div>
      <div className="mainContain">
        <div className="title">
          <h2>Báo cáo hệ thống tháng 1 năm 2023</h2>
        </div>
