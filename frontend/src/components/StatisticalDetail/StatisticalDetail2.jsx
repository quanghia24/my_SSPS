...
const StatisticalDetail2 = () => {
  const data = [
    { id: 1, printer: "Máy in 1", orderNumber: 13, pagesA3: 2, pagesA4: 14 },
    { id: 2, printer: "Máy in 2", orderNumber: 2, pagesA3: 18, pagesA4: 21 },
    { id: 3, printer: "Máy in 3", orderNumber: 12, pagesA3: 13, pagesA4: 11 },
    { id: 4, printer: "Máy in 4", orderNumber: 4, pagesA3: 12, pagesA4: 11 },
    { id: 5, printer: "Máy in 5", orderNumber: 5, pagesA3: 1, pagesA4: 12 },
  ];
  const barData = {
  ...
  return (
    <div>
      <div className="mainContain">
        <div className="title">
          <h2>Báo cáo hệ thống tháng 2 năm 2023</h2>
        </div>
...
export default StatisticalDetail2